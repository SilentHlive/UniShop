    ...
    private void loginUser(final String email, final String pass) {
        ...
        class LoginUser extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest("http://www.simplehlife.com/uniShop/php/login.php",hashMap);
    ...
    private void sendPassword(final String forgotemail) {
        class SendPassword extends AsyncTask<Void,String,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("http://www.simplehlife.com/uniShop/php/verifyemail.php",hashMap);
                return s;
            }
            @Override
            protected void onPostExecute(String s) {
